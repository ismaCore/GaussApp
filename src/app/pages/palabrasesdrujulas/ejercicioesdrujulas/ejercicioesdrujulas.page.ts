...
@Component({
  selector: 'app-ejercicioesdrujulas',
  templateUrl: './ejercicioesdrujulas.page.html',
  styleUrls: ['./ejercicioesdrujulas.page.scss'],
})
export class EjercicioesdrujulasPage implements OnInit {
  Palabras: Palabra[] = [];
